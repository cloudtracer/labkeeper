...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RadiusLogin.lab'
        db.add_column(u'radiusd_radiuslogin', 'lab',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, related_name='radius_logins', to=orm['labs.Lab']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RadiusLogin.lab'
        db.delete_column(u'radiusd_radiuslogin', 'lab_id')
    ...
    models = {
        ...
        u'labs.consoleserverport': {
            'Meta': {'ordering': "['consoleserver', 'number']", 'unique_together': "(('consoleserver', 'number'), ('consoleserver', 'telnet_port'), ('consoleserver', 'ssh_port'))", 'object_name': 'ConsoleServerPort'},
        ...
        u'radiusd.radiuslogin': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lab': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'radius_logins'", 'to': u"orm['labs.Lab']"}),
