...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RadiusLogin.consoleserverport'
        db.delete_column(u'radiusd_radiuslogin', 'consoleserverport_id')

        # Adding field 'RadiusLogin.device'
        db.add_column(u'radiusd_radiuslogin', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='radius_logins', to=orm['labs.Device']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RadiusLogin.consoleserverport'
        db.add_column(u'radiusd_radiuslogin', 'consoleserverport',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='radius_logins', to=orm['labs.ConsoleServerPort']),
                      keep_default=False)

        # Deleting field 'RadiusLogin.device'
        db.delete_column(u'radiusd_radiuslogin', 'device_id')
