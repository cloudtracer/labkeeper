...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.lab'
        db.add_column(u'scheduler_reservation', 'lab',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='reservations', to=orm['labs.Lab']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.lab'
        db.delete_column(u'scheduler_reservation', 'lab_id')
