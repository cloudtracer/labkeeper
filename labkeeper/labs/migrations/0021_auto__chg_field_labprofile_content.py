...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabProfile.content'
        db.alter_column(u'labs_labprofile', 'content', self.gf('django_bleach.models.BleachField')())

    def backwards(self, orm):

        # Changing field 'LabProfile.content'
        db.alter_column(u'labs_labprofile', 'content', self.gf('tinymce.models.HTMLField')())
