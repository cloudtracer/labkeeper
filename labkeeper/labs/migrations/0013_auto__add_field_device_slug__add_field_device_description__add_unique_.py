...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'labs_device', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'Device.description'
        db.add_column(u'labs_device', 'description',
        ...
        # Adding field 'Pod.slug'
        db.add_column(u'labs_pod', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=30),
                      keep_default=False)


        # Changing field 'Pod.name'
        db.alter_column(u'labs_pod', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'labs_device', 'slug')

        # Deleting field 'Device.description'
        db.delete_column(u'labs_device', 'description')

        # Deleting field 'Pod.slug'
        db.delete_column(u'labs_pod', 'slug')


        # Changing field 'Pod.name'
        db.alter_column(u'labs_pod', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
