...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Lab', fields ['name']
        db.create_unique(u'labs_lab', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lab', fields ['name']
        db.delete_unique(u'labs_lab', ['name'])
