...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ConsoleServerPort', fields ['number', 'consoleserver']
        db.create_unique(u'labs_consoleserverport', ['number', 'consoleserver_id'])

        # Adding unique constraint on 'Device', fields ['pod', 'name']
        db.create_unique(u'labs_device', ['pod_id', 'name'])

        # Adding unique constraint on 'Pod', fields ['name', 'lab']
        db.create_unique(u'labs_pod', ['name', 'lab_id'])
        ...
        # Adding unique constraint on 'ConsoleServer', fields ['ip4_address', 'lab']
        db.create_unique(u'labs_consoleserver', ['ip4_address', 'lab_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConsoleServer', fields ['ip4_address', 'lab']
        db.delete_unique(u'labs_consoleserver', ['ip4_address', 'lab_id'])
        ...
        # Removing unique constraint on 'Pod', fields ['name', 'lab']
        db.delete_unique(u'labs_pod', ['name', 'lab_id'])

        # Removing unique constraint on 'Device', fields ['pod', 'name']
        db.delete_unique(u'labs_device', ['pod_id', 'name'])

        # Removing unique constraint on 'ConsoleServerPort', fields ['number', 'consoleserver']
        db.delete_unique(u'labs_consoleserverport', ['number', 'consoleserver_id'])
