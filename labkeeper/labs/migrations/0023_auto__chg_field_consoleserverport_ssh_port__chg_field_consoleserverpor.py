...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsoleServerPort.ssh_port'
        db.alter_column(u'labs_consoleserverport', 'ssh_port', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ConsoleServerPort.telnet_port'
        db.alter_column(u'labs_consoleserverport', 'telnet_port', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ConsoleServerPort.ssh_port'
        raise RuntimeError("Cannot reverse this migration. 'ConsoleServerPort.ssh_port' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ConsoleServerPort.telnet_port'
        raise RuntimeError("Cannot reverse this migration. 'ConsoleServerPort.telnet_port' and its values cannot be restored.")
