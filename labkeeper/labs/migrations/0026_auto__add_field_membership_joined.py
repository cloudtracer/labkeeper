...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.joined'
        db.add_column(u'labs_membership', 'joined',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 7, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.joined'
        db.delete_column(u'labs_membership', 'joined')
