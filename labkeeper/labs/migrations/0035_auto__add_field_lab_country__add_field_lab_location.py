...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.country'
        db.add_column(u'labs_lab', 'country',
                      self.gf('django_countries.fields.CountryField')(default='us', max_length=2),
                      keep_default=False)

        # Adding field 'Lab.location'
        db.add_column(u'labs_lab', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.country'
        db.delete_column(u'labs_lab', 'country')

        # Deleting field 'Lab.location'
        db.delete_column(u'labs_lab', 'location')
