...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LabProfile'
        db.delete_table(u'labs_labprofile')

        # Adding unique constraint on 'ConsoleServerPort', fields ['telnet_port', 'consoleserver']
        db.create_unique(u'labs_consoleserverport', ['telnet_port', 'consoleserver_id'])

        # Adding unique constraint on 'ConsoleServerPort', fields ['ssh_port', 'consoleserver']
        db.create_unique(u'labs_consoleserverport', ['ssh_port', 'consoleserver_id'])

        # Adding field 'Lab.profile'
        db.add_column(u'labs_lab', 'profile',
                      self.gf('django_bleach.models.BleachField')(default=''),
                      keep_default=False)

        # Adding field 'Lab.last_edited'
        db.add_column(u'labs_lab', 'last_edited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Lab.last_edited_by'
        db.add_column(u'labs_lab', 'last_edited_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ConsoleServerPort', fields ['ssh_port', 'consoleserver']
        db.delete_unique(u'labs_consoleserverport', ['ssh_port', 'consoleserver_id'])

        # Removing unique constraint on 'ConsoleServerPort', fields ['telnet_port', 'consoleserver']
        db.delete_unique(u'labs_consoleserverport', ['telnet_port', 'consoleserver_id'])

        # Adding model 'LabProfile'
        db.create_table(u'labs_labprofile', (
            ('lab', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['labs.Lab'])),
            ('content', self.gf('django_bleach.models.BleachField')()),
        ...
        db.send_create_signal(u'labs', ['LabProfile'])

        # Deleting field 'Lab.profile'
        db.delete_column(u'labs_lab', 'profile')

        # Deleting field 'Lab.last_edited'
        db.delete_column(u'labs_lab', 'last_edited')

        # Deleting field 'Lab.last_edited_by'
        db.delete_column(u'labs_lab', 'last_edited_by_id')
    ...
    models = {
        ...
        u'labs.consoleserver': {
            ...
            'devices': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['labs.Device']", 'symmetrical': 'False', 'through': u"orm['labs.ConsoleServerPort']", 'blank': 'True'}),
        ...
        u'labs.consoleserverport': {
            ...
            'device': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'port'", 'unique': 'True', 'null': 'True', 'to': u"orm['labs.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'labs.lab': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'profile': ('django_bleach.models.BleachField', [], {'default': "''"})
        },
        u'labs.membership': {
