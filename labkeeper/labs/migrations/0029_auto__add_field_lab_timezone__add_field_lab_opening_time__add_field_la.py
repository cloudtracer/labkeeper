...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.timezone'
        db.add_column(u'labs_lab', 'timezone',
                      self.gf('timezone_field.fields.TimeZoneField')(default='UTC'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Lab.timezone'
        db.delete_column(u'labs_lab', 'timezone')
