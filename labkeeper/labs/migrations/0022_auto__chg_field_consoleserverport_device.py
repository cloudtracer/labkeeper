...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsoleServerPort.device'
        db.alter_column(u'labs_consoleserverport', 'device_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['labs.Device']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ConsoleServerPort.device'
        raise RuntimeError("Cannot reverse this migration. 'ConsoleServerPort.device' and its values cannot be restored.")
