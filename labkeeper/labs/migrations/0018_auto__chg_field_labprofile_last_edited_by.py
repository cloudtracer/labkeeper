...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabProfile.last_edited_by'
        db.alter_column(u'labs_labprofile', 'last_edited_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LabProfile.last_edited_by'
        raise RuntimeError("Cannot reverse this migration. 'LabProfile.last_edited_by' and its values cannot be restored.")
