...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.min_reservation'
        db.add_column(u'labs_lab', 'min_reservation',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Lab.max_reservation'
        db.add_column(u'labs_lab', 'max_reservation',
    ...
    def backwards(self, orm):
        # Deleting field 'Lab.min_reservation'
        db.delete_column(u'labs_lab', 'min_reservation')

        # Deleting field 'Lab.max_reservation'
        db.delete_column(u'labs_lab', 'max_reservation')
