...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.founded'
        db.add_column(u'labs_lab', 'founded',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 8, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.founded'
        db.delete_column(u'labs_lab', 'founded')
