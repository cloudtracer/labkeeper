...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConsoleServerPort.device'
        db.delete_column(u'labs_consoleserverport', 'device_id')

        # Adding field 'Device.cs_port'
        db.add_column(u'labs_device', 'cs_port',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='device', unique=True, to=orm['labs.ConsoleServerPort']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConsoleServerPort.device'
        db.add_column(u'labs_consoleserverport', 'device',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='port', unique=True, null=True, to=orm['labs.Device'], blank=True),
                      keep_default=False)

        # Deleting field 'Device.cs_port'
        db.delete_column(u'labs_device', 'cs_port_id')
