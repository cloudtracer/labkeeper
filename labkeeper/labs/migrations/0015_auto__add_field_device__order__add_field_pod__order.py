...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device._order'
        db.add_column(u'labs_device', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Pod._order'
        db.add_column(u'labs_pod', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device._order'
        db.delete_column(u'labs_device', '_order')

        # Deleting field 'Pod._order'
        db.delete_column(u'labs_pod', '_order')
    ...
    models = {
        ...
        u'labs.device': {
            'Meta': {'ordering': "(u'_order',)", 'unique_together': "(('pod', 'name'), ('pod', 'slug'))", 'object_name': 'Device'},
        ...
        u'labs.pod': {
            'Meta': {'ordering': "(u'_order',)", 'unique_together': "(('lab', 'name'),)", 'object_name': 'Pod'},
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
