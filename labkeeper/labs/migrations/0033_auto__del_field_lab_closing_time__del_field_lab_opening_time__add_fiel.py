...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.lab'
        db.add_column(u'labs_device', 'lab',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, related_name='devices', to=orm['labs.Lab']),
                      keep_default=False)
    ...
    models = {
        ...
        u'labs.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lab': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'devices'", 'to': u"orm['labs.Lab']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
