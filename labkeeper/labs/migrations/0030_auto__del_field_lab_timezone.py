...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Lab.timezone'
        raise RuntimeError("Cannot reverse this migration. 'Lab.timezone' and its values cannot be restored.")
