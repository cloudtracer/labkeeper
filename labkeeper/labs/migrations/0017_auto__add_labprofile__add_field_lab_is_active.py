...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'labs_labprofile', (
            ...
            ('lab', self.gf('django.db.models.fields.related.OneToOneField')(related_name='port', unique=True, to=orm['labs.Lab'])),
            ('last_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('last_edited_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content', self.gf('tinymce.models.HTMLField')()),
        ))
        db.send_create_signal(u'labs', ['LabProfile'])

        # Adding field 'Lab.is_active'
        db.add_column(u'labs_lab', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lab.is_active'
        db.delete_column(u'labs_lab', 'is_active')
    ...
    models = {
        ...
        u'labs.labprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lab': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'port'", 'unique': 'True', 'to': u"orm['labs.Lab']"}),
            'last_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_edited_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'labs.membership': {
