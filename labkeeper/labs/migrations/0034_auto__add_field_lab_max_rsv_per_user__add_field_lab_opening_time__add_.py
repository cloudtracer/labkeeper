...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.max_rsv_per_user'
        db.add_column(u'labs_lab', 'max_rsv_per_user',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Lab.opening_time'
        db.add_column(u'labs_lab', 'opening_time',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lab.closing_time'
        db.add_column(u'labs_lab', 'closing_time',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Device.lab'
        db.delete_column(u'labs_device', 'lab_id')


    def backwards(self, orm):
        # Deleting field 'Lab.max_rsv_per_user'
        db.delete_column(u'labs_lab', 'max_rsv_per_user')

        # Deleting field 'Lab.opening_time'
        db.delete_column(u'labs_lab', 'opening_time')

        # Deleting field 'Lab.closing_time'
        db.delete_column(u'labs_lab', 'closing_time')


        # User chose to not deal with backwards NULL issues for 'Device.lab'
        raise RuntimeError("Cannot reverse this migration. 'Device.lab' and its values cannot be restored.")
    ...
    models = {
        ...
        u'labs.lab': {
            ...
            'max_rsv_per_user': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
