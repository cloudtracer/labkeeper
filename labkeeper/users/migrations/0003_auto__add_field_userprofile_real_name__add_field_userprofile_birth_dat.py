...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_userprofile', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.gender'
        db.add_column(u'users_userprofile', 'gender',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'users_userprofile', 'birth_date')

        # Deleting field 'UserProfile.gender'
        db.delete_column(u'users_userprofile', 'gender')
